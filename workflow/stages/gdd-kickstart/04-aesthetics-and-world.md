...
Append Section 6 (Aesthetics & World) to the existing `docs/human-gdd.md` file.
...
*   Save their media into the corresponding section folder in `docs/assets/GDD/` (e.g., `docs/assets/GDD/6-aesthetics-and-world/`) and give you the filenames.

Once the user provides the links or filenames, **edit the `docs/human-gdd.md` file to replace the placeholders with the actual links**.
...
- [ ] Section 6 is appended to the file.
