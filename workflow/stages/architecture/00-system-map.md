...
**MANDATORY CONTEXT:** Before proceeding, you must read `workflow/shared/architecture-principles.md`. The System Map is the first artifact where these rules apply — every coupling classification and contract reservation must trace back to one or more of these principles.
