...
- Questions that affect core architecture
- Questions with high risk if wrong

**Should Answer Now** (Important)
- Questions that affect scope or features
...
- Credibility (official docs, reputable sites, expert authors)
...
Proceed to **Phase 1, Stage 4: Use Case Discovery** with `project-brief.md`, `knowledge-audit.md`, and `research-findings.md` as input.
