...
| graybox-4 | `workflow/stages/graybox/04-debug-indicators.md` | Senior Rust/Bevy Developer | Debug overlay system in `graybox-prototype/` |
...
| graybox-5-generative | `workflow/stages/graybox/05-mechanic-loop-generative.md` | Senior Rust/Bevy Developer | Updated prototype + `docs/mechanic-spec.md` |
...
- `graybox-prototype/` exists, `graybox-prototype/src/debug.rs` does not → graybox-4
- `graybox-prototype/src/debug.rs` exists, mechanics not all done → graybox-5-designed, graybox-5-generative, or graybox-5-assisted (user's choice per mechanic)
