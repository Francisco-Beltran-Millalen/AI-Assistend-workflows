...
| graybox-5-designed | `workflow/stages/graybox/05-mechanic-loop-designed.md` | Systems Designer | Updated prototype + `docs/mechanic-spec.md` + `docs/mechanic-designs/` |
...
│   ├── mechanic-designs/        ← Per-mechanic design journals (graybox-5-designed)
